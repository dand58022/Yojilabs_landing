...
export function MobileNav({ items, primaryCta }: MobileNavProps) {
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 bg-[#271D16]/18 backdrop-blur-sm lg:hidden">
          <div
            id="mobile-nav-panel"
            className="absolute inset-x-4 top-4 rounded-[var(--radius-panel)] border border-border bg-surface px-5 py-5 shadow-[var(--shadow-soft)]"
          >
