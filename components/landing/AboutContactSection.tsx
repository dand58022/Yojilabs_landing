...
export function AboutContactSection() {
  ...
  return (
    <>
        ...
        <div className="container-shell py-14 lg:py-[4.5rem]">
          ...
          >
            <div className="space-y-5">
              ...
              <h2 className="max-w-[13ch] text-4xl sm:text-5xl">{aboutContact.title}</h2>
      ...
      <section
        id="contact"
        className="page-section section-band section-band--warm relative scroll-mt-28 border-y border-border/60"
      >
        <div className="container-shell py-14 lg:py-[4.5rem]">
          <ViewportReveal
            className="grid gap-8 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)]"
            variant="rise"
          >
            <div className="space-y-5">
