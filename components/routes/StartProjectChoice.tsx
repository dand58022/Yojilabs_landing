        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <article className="card-surface px-6 py-7 sm:px-8">
            ...
            <Link
              ...
              className="mt-8 inline-flex items-center justify-center rounded-[var(--radius-card)] bg-accent px-5 py-3 text-sm font-semibold text-white transition hover:bg-accent/90"
            >
          ...
          <article className="card-surface px-6 py-7 sm:px-8">
            ...
            <Link
              ...
              className="mt-8 inline-flex items-center justify-center rounded-[var(--radius-card)] border border-border bg-surface px-5 py-3 text-sm font-semibold text-foreground transition hover:border-accent/35 hover:text-accent"
            >
